...
LDFLAGS="-static-libgcc" LIBS="-lcomctl32" CFLAGS="-O3 -Wall -fomit-frame-pointer" CXXFLAGS="$CFLAGS -static-libstdc++" ../../vpnes-0.3/configure --enable-interactive --with-ft-prefix=/usr/local/freetype --with-sdl-prefix=/usr/local/sdl-release --with-sdl_ttf-prefix=/usr/local/sdl-ttf --disable-sdltest --disable-freetypetest --host=i686-w64-mingw32 --build=i686-w64-mingw32 || exit 1
